...
> Snapshot 1
    ...
    ␊
      ...
      set bonks(val) {␊
        ...
        this[TestUnion$FieldValue] = this[getTypeValue](val, { name: 'list', typeClass: TList, valueType: { name: 'struct', typeClass: Bonk } }, 'bonks');␊
      }␊
    ␊
      get bonk() {␊
      ...
      set bonk(val) {␊
        ...
        this[TestUnion$FieldValue] = this[getTypeValue](val, { name: 'struct', typeClass: Bonk }, 'bonk');␊
      }␊
    ␊
      get newbyte() {␊
      ...
      set newbyte(val) {␊
        ...
        this[TestUnion$FieldValue] = this[getTypeValue](val, { name: 'i8', typeClass: null }, 'newbyte');␊
      }␊
    ␊
      get newshort() {␊
      ...
      set newshort(val) {␊
        ...
        this[TestUnion$FieldValue] = this[getTypeValue](val, { name: 'i16', typeClass: null }, 'newshort');␊
      }␊
    ␊
      get mySet() {␊
      ...
      set mySet(val) {␊
        ...
        this[TestUnion$FieldValue] = this[getTypeValue](val, { name: 'set', typeClass: TSet, valueType: { name: 'struct', typeClass: Bonk } }, 'mySet');␊
      }␊
    ␊
      get types() {␊
      ...
      set types(val) {␊
        ...
        this[TestUnion$FieldValue] = this[getTypeValue](val, { name: 'map', typeClass: TMap, keyType: { name: 'i32', typeClass: null }, valueType: { name: 'list', typeClass: TList, valueType: { name: 'struct', typeClass: Numbers } } }, 'types');␊
      }␊
    ␊
      static get Types() {␊
...
> Snapshot 2
    ...
    ␊
      ...
      set MY_SET(val) {␊
        ...
        this[TestUnion$FieldValue] = this[getTypeValue](val, { name: 'set', typeClass: TSet, valueType: { name: 'struct', typeClass: Bonk } }, 'MY_SET');␊
      }␊
    ␊
      get TYPES() {␊
        if(this[TestUnion$FieldName] !== 'TYPES') return null;␊
