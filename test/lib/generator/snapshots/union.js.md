    ...
    ␊
      ...
      set types(val) {␊
        if(val !== undefined) {␊
          ...
          this[TestUnion$FieldValue] = new TMap(val, 'i32', { type: TList, valueType: Numbers });␊
        }␊
      }␊
    ␊
      static get Types() {␊
        ...
        TestUnion$TypeCache = new Map();␊
         TestUnion$TypeCache.set(1, { name: 'bonks', customName: 'bonks', type: { type: TList, valueType: Bonk } });␊
         ...
         TestUnion$TypeCache.set(5, { name: 'my_set', customName: 'mySet', type: { type: TSet, valueType: Bonk } });␊
         TestUnion$TypeCache.set(6, { name: 'types', customName: 'types', type: { type: TMap, keyType: 'i32', valueType: { type: TList, valueType: Numbers } } });␊
    ...
    ␊
      static get Types() {␊
        ...
        TestUnion$TypeCache = new Map();␊
         ...
         TestUnion$TypeCache.set(3, { name: 'newbyte', customName: 'NEWBYTE', type: 'i8' });␊
         TestUnion$TypeCache.set(4, { name: 'newshort', customName: 'NEWSHORT', type: 'i16' });␊
         TestUnion$TypeCache.set(5, { name: 'my_set', customName: 'MY_SET', type: { type: TSet, valueType: Bonk } });␊
         TestUnion$TypeCache.set(6, { name: 'types', customName: 'TYPES', type: { type: TMap, keyType: 'i32', valueType: { type: TList, valueType: Numbers } } });␊
        return TestUnion$TypeCache;␊
      } ␊
    }␊
