    ...
    ␊
      ...
      set types(val) {␊
        if(val !== undefined) {␊
          ...
          this[TestUnion$FieldValue] = new TMap(val, 'i32', { name: 'list', type: Numbers });␊
        }␊
      }␊
    ␊
      static get Types() {␊
        ...
        TestUnion$TypeCache = new Map();␊
         TestUnion$TypeCache.set(1, { name: 'bonks', customName: 'bonks', type: { name: 'list', type: Bonk } });␊
         ...
         TestUnion$TypeCache.set(5, { name: 'my_set', customName: 'mySet', type: { name: 'set', type: Bonk } });␊
         TestUnion$TypeCache.set(6, { name: 'types', customName: 'types', type: { name: 'map', keyType: 'i32', valueType: { name: 'list', type: Numbers } } });␊
    ...
    ␊
      static get Types() {␊
        ...
        TestUnion$TypeCache = new Map();␊
         ...
         TestUnion$TypeCache.set(3, { name: 'newbyte', customName: 'NEWBYTE', type: 'i8' });␊
         TestUnion$TypeCache.set(4, { name: 'newshort', customName: 'NEWSHORT', type: 'i16' });␊
         TestUnion$TypeCache.set(5, { name: 'my_set', customName: 'MY_SET', type: { name: 'set', type: Bonk } });␊
         TestUnion$TypeCache.set(6, { name: 'types', customName: 'TYPES', type: { name: 'map', keyType: 'i32', valueType: { name: 'list', type: Numbers } } });␊
        return TestUnion$TypeCache;␊
      } ␊
    }␊
