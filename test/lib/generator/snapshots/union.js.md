    ...
    ␊
      ...
      set bonks(val) {␊
        if(val !== undefined) {␊
          ...
          this[TestUnion$FieldValue] = new TList(val, { name: 'struct', typeClass: Bonk });␊
        }␊
      }␊
    ␊
      get bonk() {␊
    ...
    ␊
      ...
      set mySet(val) {␊
        if(val !== undefined) {␊
          ...
          this[TestUnion$FieldValue] = new TSet(val, { name: 'struct', typeClass: Bonk });␊
        }␊
      }␊
    ␊
      get types() {␊
      ...
      set types(val) {␊
        if(val !== undefined) {␊
          ...
          this[TestUnion$FieldValue] = new TMap(val, { name: 'i32', typeClass: null }, { name: 'list', typeClass: TList, valueType: { name: 'struct', typeClass: Numbers } });␊
        }␊
      }␊
    ␊
      static get Types() {␊
