...
> Snapshot 1
    ...
    ␊
      ...
      set types(val) {␊
        if(val !== undefined) {␊
          this[TestStruct$types] = new TMap(val, 'i32', { type: TList, keyType: Numbers });␊
        }␊
      }␊
    ␊
      static get Types() {␊
        ...
        TestStruct$TypeCache = new Map();␊
         TestStruct$TypeCache.set(1, { name: 'bonks', customName: 'bonks', type: { type: TList, keyType: Bonk } });␊
         ...
         TestStruct$TypeCache.set(5, { name: 'my_set', customName: 'mySet', type: { type: TSet, keyType: Bonk } });␊
         TestStruct$TypeCache.set(6, { name: 'types', customName: 'types', type: { type: TMap, keyType: 'i32', valueType: { type: TList, keyType: Numbers } } });␊
    ...
    ␊
      static get Types() {␊
        ...
        TestStruct$TypeCache = new Map();␊
         ...
         TestStruct$TypeCache.set(3, { name: 'newbyte', customName: 'NEWBYTE', type: 'i8' });␊
         TestStruct$TypeCache.set(4, { name: 'newshort', customName: 'NEWSHORT', type: 'i16' });␊
         TestStruct$TypeCache.set(5, { name: 'my_set', customName: 'MY_SET', type: { type: TSet, keyType: Bonk } });␊
         TestStruct$TypeCache.set(6, { name: 'types', customName: 'TYPES', type: { type: TMap, keyType: 'i32', valueType: { type: TList, keyType: Numbers } } });␊
        return TestStruct$TypeCache;␊
      } ␊
    }␊
