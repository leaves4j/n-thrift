...
> Snapshot 1
    ...
    ␊
      ...
      set bonks(val) { ␊
        this[TestStruct$bonks] = this[getTypeValue](val, { name: 'list', typeClass: TList, valueType: { name: 'struct', typeClass: Bonk } }, 'bonks');␊
      }␊
    ␊
      get bonk() { return this[TestStruct$bonk]; }␊
      set bonk(val) { ␊
        this[TestStruct$bonk] = this[getTypeValue](val, { name: 'struct', typeClass: Bonk }, 'bonk');␊
      }␊
    ␊
      get newbyte() { return this[TestStruct$newbyte]; }␊
      set newbyte(val) { ␊
        this[TestStruct$newbyte] = this[getTypeValue](val, { name: 'i8', typeClass: null }, 'newbyte');␊
      }␊
    ␊
      get newshort() { return this[TestStruct$newshort]; }␊
      set newshort(val) { ␊
        this[TestStruct$newshort] = this[getTypeValue](val, { name: 'i16', typeClass: null }, 'newshort');␊
      }␊
    ␊
      get mySet() { return this[TestStruct$mySet]; }␊
      set mySet(val) { ␊
        this[TestStruct$mySet] = this[getTypeValue](val, { name: 'set', typeClass: TSet, valueType: { name: 'struct', typeClass: Bonk } }, 'mySet');␊
      }␊
    ␊
      get types() { return this[TestStruct$types]; }␊
      set types(val) { ␊
        this[TestStruct$types] = this[getTypeValue](val, { name: 'map', typeClass: TMap, keyType: { name: 'i32', typeClass: null }, valueType: { name: 'list', typeClass: TList, valueType: { name: 'struct', typeClass: Numbers } } }, 'types');␊
      }␊
    ␊
      static get Types() {␊
...
> Snapshot 2
    ...
    ␊
      ...
      set MY_SET(val) { ␊
        this[TestStruct$MY_SET] = this[getTypeValue](val, { name: 'set', typeClass: TSet, valueType: { name: 'struct', typeClass: Bonk } }, 'MY_SET');␊
      }␊
    ␊
      get TYPES() { return this[TestStruct$TYPES]; }␊
      set TYPES(val) { ␊
