...
> Snapshot 1
    ...
    ␊
      testVoid() {␊
        if (this[Test$handler] && typeof this[Test$handler].testVoid !== 'function') {␊
    ...
    ␊
      testString(my_age) {␊
        if (this[Test$handler] && typeof this[Test$handler].testString !== 'function') {␊
    ...
    ␊
      testString2(my_age, my_Name) {␊
        if (this[Test$handler] && typeof this[Test$handler].testString2 !== 'function') {␊
...
> Snapshot 1
    ...
    ␊
      blahBlah() {␊
        if (this[Test$handler] && typeof this[Test$handler].blahBlah !== 'function') {␊
    ...
    ␊
      secondtestString(myThing) {␊
        if (this[Test$handler] && typeof this[Test$handler].secondtestString !== 'function') {␊
