...
> Snapshot 1
    ...
    ␊
      ...
      set success(val) {␊
        if(val !== undefined) {␊
          this[$success] = new TMap(val, 'i32', { type: TList, valueType: Numbers });␊
      }␊
    ␊
    ...
    ␊
      static get Types() {␊
        ...
        MyTest$testMultiException$Result$TypeCache.set(0, { name: 'success', customName: 'success', type: { type: TMap, keyType: 'i32', valueType: { type: TList, valueType: Numbers } } });␊
...
> Snapshot 4
    ...
    ␊
      static get Types() {␊
        if(MyTest$testMultiException$Result$TypeCache) return MyTest$testMultiException$Result$TypeCache;␊
        MyTest$testMultiException$Result$TypeCache = new Map();␊
        MyTest$testMultiException$Result$TypeCache.set(0, { name: 'success', customName: 'success', type: { type: TSet, valueType: 'string' } });␊
        return MyTest$testMultiException$Result$TypeCache;␊
      }␊
    }␊
    exports.MyTest$testMultiException$Result = MyTest$testMultiException$Result;␊
