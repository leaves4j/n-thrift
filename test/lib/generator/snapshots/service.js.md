...
> Snapshot 1
    ...
    ␊
      ...
      set success(val) { ␊
        this[Test$secondtestString$Result$success] = this[getTypeValue](val, 'string', 'success');␊
      }␊
    ␊
      get err1() { return this[Test$secondtestString$Result$err1]; }␊
      set err1(val) { ␊
        this[Test$secondtestString$Result$err1] = this[getTypeValue](val, Xception, 'err1');␊
      }␊
    ␊
      static get Types() {␊
        ...
        Test$secondtestString$Result$TypeCache = new Map();␊
         ...
         Test$secondtestString$Result$TypeCache.set(1, { name: 'err1', customName: 'err1', type: Xception });␊
...
> Snapshot 1
    ...
    ␊
      ...
      set myThing(val) { ␊
        this[Test$secondtestString$Args$myThing] = this[getTypeValue](val, 'string', 'myThing');␊
      }␊
    ␊
      static get Types() {␊
...
> Snapshot 2
    ...
    ␊
      ...
      set my_thing(val) { ␊
        this[Test$secondtestString$Args$my_thing] = this[getTypeValue](val, 'string', 'my_thing');␊
      }␊
    ␊
      static get Types() {␊
        if(Test$secondtestString$Args$TypeCache) return Test$secondtestString$Args$TypeCache;␊
