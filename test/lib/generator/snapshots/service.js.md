...
> Snapshot 1
    ...
    ␊
      ...
      set success(val) { ␊
        this[Test$secondtestString$Result$success] = this[getTypeValue](val, { name: 'string', typeClass: null }, 'success');␊
      }␊
    ␊
      get err1() { return this[Test$secondtestString$Result$err1]; }␊
      set err1(val) { ␊
        this[Test$secondtestString$Result$err1] = this[getTypeValue](val, { name: 'struct', typeClass: Xception }, 'err1');␊
      }␊
    ␊
      static get Types() {␊
...
> Snapshot 1
    ...
    ␊
      ...
      set myThing(val) { ␊
        this[Test$secondtestString$Args$myThing] = this[getTypeValue](val, { name: 'string', typeClass: null }, 'myThing');␊
      }␊
    ␊
      static get Types() {␊
...
> Snapshot 2
    ...
    ␊
      ...
      set my_thing(val) { ␊
        this[Test$secondtestString$Args$my_thing] = this[getTypeValue](val, { name: 'string', typeClass: null }, 'my_thing');␊
      }␊
    ␊
      static get Types() {␊
        if(Test$secondtestString$Args$TypeCache) return Test$secondtestString$Args$TypeCache;␊
